...
- 单击招募卡购买到自己的备战区，卡面来自实际低多边形棋子模型。商店可收起；战斗开始时自动收起，但仍可重新展开、刷新和购买。
...
- 中央金色格用于交付。队友选中公共棋子，再点自己的空备战格领取；交付者可用同样方式撤回。公共棋子可作为跨队友合成主体，结果保留在最低公共槽及原持有者名下。
- 战斗回放期间出战阵容冻结，但商店、经验、私人备战区和公共区仍可操作；这些变更从下回合起影响出战阵容。战斗棋子均可点击查看只读详情。
- 伤害榜始终显示：战斗中实时更新，结算及下一轮备战保留上一场数据。
